...
<body>
    ...
    <main>
        <section id="about">
            ...
            <img src="images/rust_gameplay.jpg" alt="Скриншот геймплея Rust">
        </section>
        <section id="gameplay">
            <h2>Геймплей</h2>
            ...
            <img src="images/rust_combat.jpg" alt="Бой в Rust">
        </section>
        <section id="resources">
            ...
            <img src="images/rust_resources.jpg" alt="Ресурсы в Rust">
        </section>
        <section id="crafting">
            <h2>Крафтинг</h2>
            ...
            <img src="images/rust_crafting.jpg" alt="Крафтинг в Rust">
        </section>
        <section id="buildings">
            ...
            <img src="images/rust_building.jpg" alt="Строительство в Rust">
        </section>
        <section id="tips">
        ...
        <section id="community">
            ...
            <img src="images/rust_community.jpg" alt="Сообщество Rust">
        </section>
    </main>
    <footer>
